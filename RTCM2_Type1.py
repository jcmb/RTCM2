...
#        print "Time: {}".format(self.GNSS_Time)
        ...
        print " SV UDRE IOD    PRC    RRC Scale Factor"
        for SV in range(self.SVs):
            print "{:3} {} {:3} {:6.2f} {:6.2f} {}".format(self.SV_Details[SV]['SV'],RTCM2_UDRE_Names[self.SV_Details[SV]['UDRE']],self.SV_Details[SV]['IOD'],self.SV_Details[SV]['PRC'],self.SV_Details[SV]['RRC'],self.SV_Details[SV]['Scale_Factor'])
